...
public class MainActivity extends AppCompatActivity
        ...
        search_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Thread() {
                    @Override
                    public void run() {
                        jspDown jspDown = new jspDown();
                        String str = jspDown.request("https://xn--bh3b03t.com/locationData2.jsp", null);

                        try {
                            JSONObject wrapObject = new JSONObject(str);
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        try {
                                            ...
                                            Double latitude = Double.parseDouble(dataJsonObject.getString("latitude"));
                                            Double longtitude = Double.parseDouble(dataJsonObject.getString("longtitude"));
    ...
    public void showPlaceInformation(LatLng location) {
        ...
        new NRPlaces.Builder()
                ...
                .key("AIzaSyDim69UTyeci971p3LTdY9PXMVJWOQ9A-Q")
